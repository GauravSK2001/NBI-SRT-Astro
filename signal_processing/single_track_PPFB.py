...
class single_track_PPFB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_head_1 = blocks.head(gr.sizeof_float*Vector_length, one_sec_display_integration)
    ...
    def set_one_sec_display_integration(self, one_sec_display_integration):
        ...
        self.blocks_head_1.set_length(self.one_sec_display_integration)
