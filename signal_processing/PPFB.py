...
class PPFB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_1_1 = osmosdr.source(
            args="numchan=" + str(1) + " " + 'airspy=0'
        )
        self.osmosdr_source_1_1.set_clock_source('external', 0)
        self.osmosdr_source_1_1.set_time_source('external', 0)
        self.osmosdr_source_1_1.set_time_now(osmosdr.time_spec_t(time.time()), osmosdr.ALL_MBOARDS)
        self.osmosdr_source_1_1.set_sample_rate(samp_rate)
        self.osmosdr_source_1_1.set_center_freq(HI21, 0)
        self.osmosdr_source_1_1.set_freq_corr(0, 0)
        self.osmosdr_source_1_1.set_dc_offset_mode(0, 0)
        self.osmosdr_source_1_1.set_iq_balance_mode(0, 0)
        self.osmosdr_source_1_1.set_gain_mode(False, 0)
        self.osmosdr_source_1_1.set_gain(20, 0)
        self.osmosdr_source_1_1.set_if_gain(0, 0)
        self.osmosdr_source_1_1.set_bb_gain(0, 0)
        self.osmosdr_source_1_1.set_antenna('', 0)
        self.osmosdr_source_1_1.set_bandwidth(0, 0)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*Vector_length, '/Users/gauravsenthilkumar/repositories/NBI-SRT-Astro/calibration/Frequency_Cal', False)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, HI21, (1e-2), np.pi/2, 0)
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_1, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_1_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_2, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_2_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.blocks_delay_0_0_0_0_2_0_0, 0))
        ...
        self.connect((self.osmosdr_source_1_1, 0), (self.blocks_add_xx_1, 1))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.osmosdr_source_1_1.set_sample_rate(self.samp_rate)
    ...
    def set_HI21(self, HI21):
        self.HI21 = HI21
        self.analog_sig_source_x_0_0.set_frequency(self.HI21)
        self.osmosdr_source_1_1.set_center_freq(self.HI21, 0)
        self.qtgui_vector_sink_f_0_0_0.set_x_axis(((self.HI21-self.samp_rate/2)/1e6), ((self.Frequency_Step_Size)/1e6))
