...
from PPFB_hier import PPFB_hier  # grc-generated hier_block
...
class PPFB_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PPFB_test")
        ...
        self.analog_sig_source_x_0_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, HI21, 0, 0, 0)
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_SIN_WAVE, HI21, (1e-2), np.pi/2, 0)
        self.PPFB_hier_0 = PPFB_hier(
            Vector_length=2**13,
        )

        self.top_layout.addWidget(self.PPFB_hier_0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.PPFB_hier_0, 0), (self.fft_vxx_0, 0))
        ...
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 5))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 1))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 7))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 3))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 0))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 9))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 8))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 2))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 6))
        self.connect((self.blocks_add_xx_1, 0), (self.PPFB_hier_0, 4))
    ...
    def set_HI21(self, HI21):
        ...
        self.analog_sig_source_x_0_1.set_frequency(self.HI21)
        self.qtgui_vector_sink_f_0_0_0.set_x_axis(((self.HI21-self.samp_rate/2)/1e6), ((self.Frequency_Step_Size)/1e6))
...
def main(top_block_cls=PPFB_test, options=None):
