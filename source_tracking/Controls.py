...
#Ideally I want to have a parameter file which can be read by the Rot2Prog class. 
# This parameter file will contain the port, baudrate, pulses_per_degree, az_min, az_max, el_min, el_max.
# This will make the class more flexible and can be used for different rotators.
